    ...
    <div class="flex justify-between items-center h-16">
      ...
      <div class="hidden md:flex items-center justify-center flex-1">
        <div class="flex space-x-8">
          <a href="index.php" class="relative font-medium text-gray-800 hover:text-gray-600 transition-colors duration-300 group">
            Home
            <span class="absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
          </a>

          <a href="#" class="relative font-medium text-gray-800 hover:text-gray-600 transition-colors duration-300 group">
            Rooms
            <span class="absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
          </a>
          ...
          <a href="index.php#features" class="relative font-medium text-gray-800 hover:text-gray-600 transition-colors duration-300 group">
            Features
            <span class="absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
          </a>

          <a href="about-us.php" class="relative font-medium text-gray-800 hover:text-gray-600 transition-colors duration-300 group">
            About us
            <span class="absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
          </a>
        </div>
      ...
      <div class="flex items-center space-x-4">
        ...
        <?php else: ?>
        <button onclick="toggleModal()" class="bg-emerald-500 text-white px-4 py-2 rounded-md hover:bg-emerald-600 transition duration-300">
          Login
        </button>
        <?php endif; ?>
      </div>
  ...
  <div class="relative bg-white/90 backdrop-blur-sm p-6 rounded-lg shadow-lg w-96">
    ...
    <form class="flex flex-col items-center" action="index.php" method="POST">
      ...
      <div class="mb-4 w-80 mx-auto">
        ...
        <input type="email" id="email" name="email" class="w-full px-4 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-700 outline-none transition-all duration-300 focus:border-[#00254a] focus:ring-1" required placeholder="Enter your email">
      </div>
      ...
      <div class="mb-4 w-80 mx-auto relative">
        ...
        <!-- Show Password -->
        <button type="button" onclick="togglePassword('password','eyeIcon', event)" class="absolute inset-y-0 right-3 flex items-center pt-4"></button>
      </div>
...
<div id="signupModal" class="hidden fixed inset-0 flex items-center justify-center z-50">
  ...
  <div class="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all duration-300">
    ...
    <div class="p-8">
      ...
      <form class="space-y-6" action="index.php" method="POST">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="text" id="fullName" name="full_name" 
                   class="pl-10 w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50 text-gray-900 
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="tel" id="contactNumber" name="contact_number" 
                   class="pl-10 w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50 text-gray-900 
                          focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-300" 
                   required placeholder="+63 XXX XXX XXXX" 
                   pattern="[0-9]+" 
        ...
        <button type="submit" name="signup" 
                class="w-full py-3 px-4 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 
...
<div id="forgotPasswordModal" class="hidden fixed inset-0 flex items-center justify-center z-50">
  ...
  <div class="relative bg-white/90 backdrop-blur-sm p-6 rounded-lg w-96">
    ...
    <form id="resetCodeForm" action="handlers/reset_password_handler.php" method="POST" class="hidden space-y-6" onsubmit="return validatePasswords()">
      <!-- Timer Display -->
      ...
      <div>
        ...
        <input type="text" id="resetCode" name="reset_code" 
               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50 text-gray-900 
