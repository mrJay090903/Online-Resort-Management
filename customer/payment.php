          ...
          <div class="space-y-3">
            ...
            <div class="pt-4 border-t">
                ...
                <div class="flex justify-between text-sm">
                    <span>Room Rate (<?php echo $booking_data['booking_type'] === 'day' ? 'Day Use' : 'Night Use'; ?>):</span>
                    <span>₱<?php echo number_format($booking_data['price_per_day'], 2); ?> × <?php echo $booking_data['days']; ?> days</span>
                </div>
