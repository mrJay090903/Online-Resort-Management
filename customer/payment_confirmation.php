                ...
                <div class="p-8">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold">#<?php echo str_pad($success_data['booking_id'], 8, '0', STR_PAD_LEFT); ?></span>
                        </div>
                    </div>

                    <!-- Action Buttons -->
                    <div class="space-y-3">
                        <a href="my_bookings.php" class="block w-full bg-emerald-600 text-white text-center py-3 rounded-lg hover:bg-emerald-700 transition-colors">
                            View My Bookings
                        </a>
