...
>>>>>>> a74a46121f3b6b7d8f1a89fd5855705a640cfa1a
...
<<<<<<< HEAD
        ...
        <div class="mb-4 w-84 mx-auto relative">
          <input type="password" id="signupPassword" name="password"
            class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-md bg-gray-100 text-gray-700 outline-none transition-all duration-300 focus:border-[#00254a] focus:ring-1"
        ...
        <p class="mt-4 text-sm">Already have an account? <span onclick="switchToLogin()"
            class="text-[#00B58B] font-semibold hover:underline cursor-pointer">Login</span></p>
      </form>
    </div>
  </div>
  ...
  <section class="text-center py-25 px-6 mt-2">
    ...
    <p class="mt-10 text-gray-600 max-w-3xl mx-auto font-['Ubuntu_Sans']">
      ...
      Just minutes from Guinobatan Centro, our resort offers a peaceful retreat surrounded by nature. Take a dip in our
    ...
    <div class="container mx-auto px-6 text-center">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="bg-gray-100 p-8 rounded-lg shadow-md">
          <img src="assets/jonathan.png" alt="Jonathan B." class="w-16 h-16 mx-auto rounded-full mb-4">
          <p class="italic text-gray-600">
            "The exceptional customer service and delicious catering exceeded all expectations. Paired with the stunning
