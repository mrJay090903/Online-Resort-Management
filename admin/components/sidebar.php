  ...
  <div x-data="{ open: true }" class="flex">
    ...
    <div :class="open ? 'w-64' : 'w-16'" class="min-h-screen bg-emerald-500 text-white transition-all duration-300">
      <div class="p-4 flex items-center justify-between">
        <img src="/Online-Resort-Management/admin/assets/logos.png" alt="Logo" class="w-36 h-13" x-show="open" x-cloak>
      ...
      <nav class="mt-4 space-y-2">
        ...
        <a href="dashboard.php" class="flex items-center px-6 py-3 text-white hover:bg-emerald-600" :class="{'justify-center': !open}">
        ...
        <a href="rooms.php" class="flex items-center px-6 py-3 text-white hover:bg-emerald-600" :class="{'justify-center': !open}">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="cottage.php" class="flex items-center px-6 py-3 text-white hover:bg-emerald-600" :class="{'justify-center': !open}">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
          </svg>
          <span x-show="open" x-cloak class="ml-3">Cottage/Hall</span>
        </a>

        <a href="features.php" class="flex items-center px-6 py-3 text-white hover:bg-emerald-600" :class="{'justify-center': !open}">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="relative" x-data="{ dropdownOpen: false }">
          <button @click="dropdownOpen = !dropdownOpen" class="flex items-center w-full px-6 py-3 hover:bg-emerald-600" :class="{'justify-center': !open}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-auto transition-transform duration-200"
              :class="{ 'rotate-180': dropdownOpen, 'hidden': !open }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
            </svg>
          </button>

          <div x-show="dropdownOpen" x-cloak x-transition 
            class="pl-11" :class="{'pl-0': !open}">
        ...
        <div class="relative" x-data="{ dropdownOpen: window.location.pathname.includes('customer_account.php') || window.location.pathname.includes('staff_account.php') }">
          <button @click="dropdownOpen = !dropdownOpen" class="flex items-center w-full px-6 py-3 hover:bg-emerald-600" :class="{'justify-center': !open}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="reports.php" class="flex items-center px-6 py-3 text-white hover:bg-emerald-600" :class="{'justify-center': !open}">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="logout.php" class="flex items-center px-6 py-3 text-white hover:bg-emerald-600" :class="{'justify-center': !open}">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
          </svg>
          <span x-show="open" x-cloak class="ml-3">Logout</span>
        </a>        
      </nav>
    </div>
  </div>
