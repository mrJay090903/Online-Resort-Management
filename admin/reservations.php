            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead class="bg-gray-50">
                ...
                <?php while ($booking = $bookings->fetch_assoc()): ?>
                  ...
                  <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900"><?php echo htmlspecialchars($booking['customer_name']); ?></div>
                                            <div class="text-sm text-gray-500"><?php echo htmlspecialchars($booking['contact_number']); ?></div>
